...
class ToonShaderCB : public video::IShaderConstantSetCallBack
{
public:
	ToonShaderCB(EffectHandler* effectIn) : effect(effectIn) {};
...
//		services->setVertexShaderConstant("ViewI", worldViewProj.pointer(), 16);
		...
		services->setVertexShaderConstant("mLightPos", reinterpret_cast<f32*>(&lightPosOS), 4);
		...
		services->setVertexShaderConstant("mCamPos", reinterpret_cast<f32*>(&eyePos.X), 4);
