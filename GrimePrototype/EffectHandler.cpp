...
AmbientColour(0x0)
{
    ...
    stringc TOON = shaderDirectory + stringc("ShaderToon") + platformExt;
			   ...
			   (driver->getDriverType() == EDT_DIRECT3D9 && driver->queryFeature(EVDF_PIXEL_SHADER_1_4))))
	{
			...
			ToonShaderCB* mc99 = new ToonShaderCB(this);

			Effects[EET_BRDF] = gpu->addHighLevelShaderMaterialFromFiles(
				BRDFV.c_str(), "vertexMain", video::EVST_VS_2_0,
				BRDFP.c_str(), "pixelMain", video::EPST_PS_2_0,
				mc4, video::EMT_SOLID);

			Effects[EET_GOOCH] = gpu->addHighLevelShaderMaterialFromFiles(
				GOOCHV.c_str(),	"vertexMain", video::EVST_VS_2_0,
				GOOCHP.c_str(), "pixelMain", video::EPST_PS_2_0,
				mc5, video::EMT_SOLID);

			Effects[EET_MRWIGGLE] = gpu->addHighLevelShaderMaterialFromFiles(
				WIGGLEV.c_str(), "vertexMain", video::EVST_VS_2_0,
				WIGGLEP.c_str(), "pixelMain", video::EPST_PS_2_0,
				mc6, video::EMT_SOLID);

			Effects[EET_ANISO] = gpu->addHighLevelShaderMaterialFromFiles(
				ANISOV.c_str(),	"vertexMain", video::EVST_VS_2_0,
				ANISOP.c_str(), "pixelMain", video::EPST_PS_2_0,
				mc8, video::EMT_SOLID);

			Effects[EET_PHONG] = gpu->addHighLevelShaderMaterialFromFiles(
				PHONGV.c_str(),	"vertexMain", video::EVST_VS_2_0,
				PHONGP.c_str(), "pixelMain", video::EPST_PS_2_0,
				mc9, video::EMT_SOLID);
		    
		    Effects[EET_TOON] = gpu->addHighLevelShaderMaterialFromFiles(
		        TOON.c_str(), "vertexMain", video::EVST_VS_2_0,
		        TOON.c_str(), "pixelMain", video::EPST_PS_2_0,
		        mc99, video::EMT_SOLID);
